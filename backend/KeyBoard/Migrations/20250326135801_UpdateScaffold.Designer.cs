...
namespace KeyBoard.Migrations
{
    ...
    [Migration("20250326135801_UpdateScaffold")]
    partial class UpdateScaffold
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetRole", b =>
                {
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("KeyBoard.Data.AspNetRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KeyBoard.Data.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetRoleClaim", b =>
                {
                    b.HasOne("KeyBoard.Data.AspNetRole", "Role")
            ...
            modelBuilder.Entity("KeyBoard.Data.AspNetUserClaim", b =>
                {
                    b.HasOne("KeyBoard.Data.AspNetUser", "User")
